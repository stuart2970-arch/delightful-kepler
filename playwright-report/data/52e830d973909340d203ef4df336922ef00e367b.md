...
- generic [active] [ref=f1e1]:
  ...
  - main [ref=f1e3]:
    - generic [ref=f1e4]:
      ...
      - button "Continue with Google" [ref=f1e11]
      - paragraph [ref=f1e18]:
        - text: By continuing with Google, you agree to StyleFlo's
        - button "Terms of Service" [ref=f1e19]
        - text: and acknowledge our
        - button "Privacy Policy" [ref=f1e20]
        - text: .
      - generic [ref=f1e21]: Or continue with credentials
      - generic [ref=f1e25]:
        - generic [ref=f1e26]:
          - generic [ref=f1e27]: Email Address
          - textbox "you@example.com" [ref=f1e28]
        - generic [ref=f1e29]:
          - generic [ref=f1e30]: Password
          - textbox "••••••••" [ref=f1e31]
        - button "Sign In" [ref=f1e32]
      - button "Don't have an account? Sign up" [ref=f1e34]
