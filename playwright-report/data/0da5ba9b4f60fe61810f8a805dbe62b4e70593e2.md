...
- Name: multi-colleague.spec.ts >> Multi-Colleague Dashboard & RBAC Rota Systems >> Role: Colleague (sarah.miller@acme.com) >> Colleague Dashboard Operations >> should prevent colleague from accessing admin endpoints directly (CORS/RLS enforcement)
- Location: tests\multi-colleague.spec.ts:117:11
