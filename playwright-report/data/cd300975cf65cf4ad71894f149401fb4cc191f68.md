...
- Name: styleflo-onboarding-e2e-v2.spec.ts >> StyleFlo Conversational Onboarding & Security Boundary Tests (v2) >> should successfully complete the onboarding journey via Google Places auto-fill
- Location: tests\styleflo-onboarding-e2e-v2.spec.ts:16:7
