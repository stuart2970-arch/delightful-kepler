...
- Name: multi-colleague.spec.ts >> Multi-Colleague Dashboard & RBAC Rota Systems >> Role: Colleague (sarah.miller@acme.com) >> should trigger automatic RBAC matching on colleague sign-up
- Location: tests\multi-colleague.spec.ts:84:9
...
- generic [active] [ref=f1e1]:
  ...
  - main [ref=f1e3]:
    - generic [ref=f1e4]:
      - generic [ref=f1e5]:
        - heading "Welcome to StyleFlo" [level=1] [ref=f1e9]
        - paragraph [ref=f1e10]: Sign in to manage your AI chatbots
      - generic [ref=f1e11]:
        - generic [ref=f1e12]:
          - generic [ref=f1e13]: Email Address
          - textbox "you@example.com" [ref=f1e14]
        - generic [ref=f1e15]:
          - generic [ref=f1e16]: Password
          - textbox "••••••••" [ref=f1e17]
        - button "Sign In" [ref=f1e18]
      - button "Don't have an account? Sign up" [ref=f1e20]
  - button "Open Next.js Dev Tools" [ref=f1e26] [cursor=pointer]
  - alert [ref=f1e30]
```
