    ...
    <div className="space-y-6">
      ...
      {showImpersonateModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-[var(--awb-color1)] border border-[var(--awb-color3)] rounded-2xl p-6 max-w-2xl w-full shadow-2xl relative overflow-hidden flex flex-col h-[80vh]">
            <div className="absolute top-0 left-0 w-full h-1 bg-amber-500"></div>
            
            <div className="flex justify-between items-center mb-6 shrink-0">
              <h3 className="text-xl font-bold text-[var(--awb-color8)]">Impersonate Tenant</h3>
              <button onClick={() => setShowImpersonateModal(false)} className="text-[var(--awb-color6)] hover:text-[var(--awb-color8)]">
            ...
            <div className="flex-1 overflow-y-auto space-y-2 pr-2 custom-scrollbar">
              {isSearching ? (
                ...
                <div className="text-center py-8 text-[var(--awb-color6)] text-sm">No tenants or chatbots found matching "{searchQuery}"</div>
              ) : (
