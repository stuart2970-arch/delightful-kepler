      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
        {!twilioShadowNumber ? (
          <div className="flex flex-col items-center justify-center text-center space-y-6 py-12">
            <div className="w-20 h-20 bg-[#198fd9] text-white font-semibold rounded-[4px] px-[29px] py-[13px]/20 rounded-full flex items-center justify-center mb-2">
            ...
            <button
              ...
              className="bg-[#198fd9] text-white font-semibold rounded-[4px] px-[29px] py-[13px] hover:bg-[#198fd9] text-white font-semibold rounded-[4px] px-[29px] py-[13px] text-[var(--awb-color8)] font-semibold py-3 px-8 rounded-xl shadow-lg shadow-indigo-500/20 transition-all flex items-center justify-center space-x-2"
            >
              {isProvisioning ? (
                <>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="bg-[#198fd9] text-white font-semibold rounded-[4px] px-[29px] py-[13px]/10 border border-indigo-500/30 text-[var(--awb-color5)] px-6 py-4 rounded-xl text-3xl font-mono tracking-wider shadow-inner">
                    {twilioShadowNumber}
                  </div>
                </div>
              </div>
            ...
            <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-6">
              <h4 className="text-amber-900 font-semibold text-lg mb-3 flex items-center">
