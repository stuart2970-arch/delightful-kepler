...
export default function IntegrationsView() {
  ...
  const [rwgBusinessName, setRwgBusinessName] = useState(rwgConfig?.rwg_business_name || rwgConfig?.business_name || tenantName || '');
  const [rwgStreetAddress, setRwgStreetAddress] = useState(rwgAddressSameAsTrading ? (tradingAddressStreet || businessAddress || '') : (rwgConfig?.rwg_street_address || rwgConfig?.street_address || tradingAddressStreet || businessAddress || ''));
  const [rwgCity, setRwgCity] = useState(rwgAddressSameAsTrading ? (tradingAddressCity || '') : (rwgConfig?.rwg_city || rwgConfig?.city || tradingAddressCity || ''));
  const [rwgPostcode, setRwgPostcode] = useState(rwgAddressSameAsTrading ? (tradingAddressPostcode || postcode || '') : (rwgConfig?.rwg_postcode || rwgConfig?.postcode || tradingAddressPostcode || postcode || ''));
  ...
  useEffect(() => {
    ...
    setRwgPhone(rwgAddressSameAsTrading ? (tradingAddressPhone || twilioShadowNumber || '') : (rwgConfig?.rwg_phone || rwgConfig?.telephone || tradingAddressPhone || twilioShadowNumber || ''));
    setIsRegisteredBusinessAddress(rwgConfig?.is_registered_business_address || false);
  }, [rwgConfig, rwgAddressSameAsTrading, tradingAddressStreet, tradingAddressCity, tradingAddressPostcode, tradingAddressPhone, businessAddress, postcode, tenantName, twilioShadowNumber]);
                    ...
                    <div className="space-y-4 pt-2">
                      ...
                      <div className="flex flex-col md:flex-row gap-3">
                        ...
                        <div className="flex items-end pb-[1px]">
                          <button 
                            ...
                            className="awb-btn w-full min-h-[50px] flex items-center justify-center gap-2 shadow-sm disabled:opacity-50 text-xs sm:text-sm px-4"
                          >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t border-[#f2f3f5]">
                        ...
                        <div>
                          ...
                          <input type="text" value={rwgPhone} onChange={(e) => setRwgPhone(e.target.value)} disabled={rwgAddressSameAsTrading} className="w-full h-[50px] bg-white disabled:bg-gray-100/80 disabled:text-[#212326] font-semibold disabled:cursor-not-allowed border border-[#f2f3f5] rounded-[6px] px-3.5 py-2 text-sm text-[#212326] focus:outline-none focus:border-[#65bd7d] placeholder-gray-400" placeholder="+44 123 456 7890" />
                        </div>
                        <div className="md:col-span-2">
                          <label className="block text-xs font-semibold text-[#212326] mb-1.5">Street Address</label>
                          <input type="text" value={rwgStreetAddress} onChange={(e) => setRwgStreetAddress(e.target.value)} disabled={rwgAddressSameAsTrading} className="w-full h-[50px] bg-white disabled:bg-gray-100/80 disabled:text-[#212326] font-semibold disabled:cursor-not-allowed border border-[#f2f3f5] rounded-[6px] px-3.5 py-2 text-sm text-[#212326] focus:outline-none focus:border-[#65bd7d] placeholder-gray-400" placeholder="123 Salon Street" />
                        </div>
                        <div>
                          <label className="block text-xs font-semibold text-[#212326] mb-1.5">City</label>
                          <input type="text" value={rwgCity} onChange={(e) => setRwgCity(e.target.value)} disabled={rwgAddressSameAsTrading} className="w-full h-[50px] bg-white disabled:bg-gray-100/80 disabled:text-[#212326] font-semibold disabled:cursor-not-allowed border border-[#f2f3f5] rounded-[6px] px-3.5 py-2 text-sm text-[#212326] focus:outline-none focus:border-[#65bd7d] placeholder-gray-400" placeholder="London" />
                        </div>
                        <div>
                          <label className="block text-xs font-semibold text-[#212326] mb-1.5">Postcode</label>
                          <input type="text" value={rwgPostcode} onChange={(e) => setRwgPostcode(e.target.value)} disabled={rwgAddressSameAsTrading} className="w-full h-[50px] bg-white disabled:bg-gray-100/80 disabled:text-[#212326] font-semibold disabled:cursor-not-allowed border border-[#f2f3f5] rounded-[6px] px-3.5 py-2 text-sm text-[#212326] focus:outline-none focus:border-[#65bd7d] placeholder-gray-400" placeholder="SW1A 1AA" />
                        </div>
                      </div>
