...
- Name: styleflo-onboarding-e2e-v2.spec.ts >> StyleFlo Conversational Onboarding & Security Boundary Tests (v2) >> should restore abandoned onboarding progress when user inputs FLO resumption code
- Location: tests\styleflo-onboarding-e2e-v2.spec.ts:63:7
...
Locator: locator('#styleflo-chat-inline').locator('text=Flo')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#styleflo-chat-inline').locator('text=Flo')
...
- main:
  - img "FloBot Avatar"
  - heading "StyleFlo Assistant Builder FloBot AI" [level=1]
  - paragraph: Official Salon AI Receptionist Builder
  ...
  - img "Agent Avatar"
  - heading "Flo" [level=3]
  - paragraph: StyleFlo AI Receptionist Builder
  - heading "Welcome to StyleFlo AI" [level=4]
  - paragraph: Let's build your AI receptionist in 60 seconds
  ...
  - checkbox "I agree to StyleFlo's Terms of Service and acknowledge the Privacy Policy."
  - text: I agree to StyleFlo's
  - link "Terms of Service":
    - /url: https://styleflo.ai/terms-conditions/
  - text: and acknowledge the
  - link "Privacy Policy":
    - /url: https://styleflo.ai/privacy/
  - text: .
  - button "Start Onboarding with FloBot ⚡"
  - link "⚡ Powered by StyleFlo":
    - /url: http://localhost:3000/api/track?ref=styleflo-onboarding-flobot&source=localhost
    - text: ⚡ Powered by
    - strong: StyleFlo
  - text: By proceeding, you agree to StyleFlo's
