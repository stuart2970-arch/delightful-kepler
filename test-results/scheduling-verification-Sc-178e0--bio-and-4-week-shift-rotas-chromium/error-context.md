...
- Name: scheduling-verification.spec.ts >> Scheduling & Staff Section Verification >> Staff Member Creation & Update API validates avatar image, specialist services, bio, and 4-week shift rotas
- Location: tests\scheduling-verification.spec.ts:50:7
