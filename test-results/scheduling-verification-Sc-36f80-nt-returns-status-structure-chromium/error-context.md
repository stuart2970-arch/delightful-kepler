...
- Name: scheduling-verification.spec.ts >> Scheduling & Staff Section Verification >> Google Calendar Integration status endpoint returns status structure
- Location: tests\scheduling-verification.spec.ts:33:7
