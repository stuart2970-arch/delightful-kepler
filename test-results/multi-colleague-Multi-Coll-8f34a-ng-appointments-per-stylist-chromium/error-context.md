...
- Name: multi-colleague.spec.ts >> Multi-Colleague Dashboard & RBAC Rota Systems >> Role: Account Owner (t0000000-0000-0000-0000-000000000001) >> should display side-by-side Master Schedule grouping appointments per stylist
- Location: tests\multi-colleague.spec.ts:68:9
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    5 × locator resolved to <html lang="en" class="poppins_a9eef06b-module__e3suya__variable inter_4d9b5f00-module__5ifLia__variable antialiased">…</html>
